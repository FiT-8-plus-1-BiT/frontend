...
const LiveSessionItem = function LiveSessionItem({
  ...
  return (
    <div
      className="relative flex flex-col w-[27.6vw] 2xl:h-[29vw] h-[37vw] rounded-xl overflow-hidden shadow hover:shadow-md cursor-pointer bg-white"
      onClick={onClick}
    >
      {/* 실시간 뱃지 */}
      {isLive && (
      ...
      <div className="p-5 flex flex-col gap-3 flex-1">
        ...
        <div className="flex justify-between items-start gap-4">
          <div className="xl:text-[1.4vw] text-[1.2vw] font-black leading-snug text-gray-900 flex-1 break-words">
            {title}
          </div>
          <button
            onClick={(e) => {
        ...
        {/* 혼잡도 (하단 고정) */}
        <div className="flex items-center justify-center w-[138px] h-[38px] rounded-[4px] bg-gray-100 gap-[8px] py-[4px] px-[16px] mt-auto">
