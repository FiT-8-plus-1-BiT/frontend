...
const categories = ['AI', 'Blockchain', 'Design', 'Cloud', 'Cybersecurity', 'Data Science'];
const topics = ['Neural Networks', 'Decentralized Finance', 'User Experience', 'Infrastructure', 'Network Security', 'Data Analysis'];
const contentTypes = ['Lecture', 'Panel Discussion', 'Workshop'];
const levels = ['Beginner', 'Intermediate', 'Advanced'];
const tags = ['Machine Learning', 'Web3', 'Product Design', 'AWS', 'Hacking', 'Big Data', 'Analytics', 'DevOps'];
